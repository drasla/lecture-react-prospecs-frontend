...
function CartPage() {
    ...
    if (loading && items.length === 0)
        return <div className={twMerge(["py-40", "text-center"])}>Loading...</div>;
                        ...
                        return (
                            <div
                                ...
                                <div
                                    ...
                                    <div className={twMerge(["w-12", "text-right"])}>
                                        <button
                                            onClick={() => removeItem(item.id)}
                                            className={twMerge(["text-gray-400", "p-2"])}>
                                            <FiX size={20} />
                                        </button>
                                    </div>
                                </div>
